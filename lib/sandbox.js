...
function init ( ) {
  ...
  sbx.serverInit = function serverInit (env, ctx) {
    ...
    var patient_id = '04232347';
    var timeStamp = moment().unix();
    var message = patient_id + '_' + timeStamp + '_' + ctx.ddata.profileTreatments.toString() + '_' + ctx.ddata.tempbasalTreatments.toString() + '_' + ctx.ddata.combobolusTreatments.toString();  
